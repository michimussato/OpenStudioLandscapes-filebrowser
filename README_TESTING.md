<!-- TOC -->
* [OpenStudioLandscapes-filebrowser](#openstudiolandscapes-filebrowser)
<!-- TOC -->
...
Instead of the [`definitions.py`](src/OpenStudioLandscapes/filebrowser/definitions.py), 
the accompanying [`workspace.yaml`](workspace.yaml) loads 
the [`_definitions_with_upstream_specs.py`](src/OpenStudioLandscapes/filebrowser/_definitions_with_upstream_specs.py) 
which also contains 
