...
| `FILEBROWSER_DB`             | `str`  | `{DOT_FEATURES}/OpenStudioLandscapes-filebrowser/.payload/data/filebrowser.db`     |
| `FILEBROWSER_JSON`           | `str`  | `{DOT_FEATURES}/OpenStudioLandscapes-filebrowser/.payload/config/filebrowser.json` |
